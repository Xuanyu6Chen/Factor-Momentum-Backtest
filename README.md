...
\[
\text{MOM}_{i,t} = \frac{P_{i,t-1\text{m}}}{P_{i,t-12\text{m}}} - 1
\]
where \( P_{i,t-1\text{m}} \) is the price one month before \( t \) and \( P_{i,t-12\text{m}} \) is the price twelve months before \( t \).
...
\[
r_{p,t} = \sum_i w_{i,t} \cdot r_{i,t}
\]
